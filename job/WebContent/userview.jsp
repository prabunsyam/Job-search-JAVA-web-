...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	   ...
	   <%
		userservice rr=new userservice();
	   ArrayList<usermod>arr1=rr.selectAllRegistration();
	   %>
<div class="banner">
	<div class="container">
...
<td bgcolor="#6699ff"><div align="center"><strong>gender</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>dob</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>age</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>ph</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>qualification</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>year of pass</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>exp</strong></div></td>
...
<td bgcolor="#6699ff"><div align="center"><strong>approval</strong></div></td>
</tr>
</tr>
<%
for(usermod rm:arr1)
...
<input type="hidden"name="id"value="<%=rm.getId() %>">
...
<label><input type="submit"name="operation"id="button1SS"value="Change"tabindex="7"/>
</label>
