	...
	<div class="container">
	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav">
		        ...
		        <li><a href="userpro.jsp">back</a></li>
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <h2>job search</h2>
        <form method="post"action="jobsrch.jsp">
           <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                    <select path="qli" name="qli" id="qli" class="form-control input-sm">
                        ...
                        <%for(qualimod qm:arr2){%>
                        <option value="<%=qm.getQualificationid()%>"><%=qm.getQualification()%></option>
                   <%} %>
                    </select>
                </div>
            </div></div>
...
ArrayList<vacmod>arrayList=vs.search(ql,skl);
%>
...
<td bgcolor="#6699ff"><div align="center"><strong>company</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>post</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>vacancy</strong></div></td>
...
<td bgcolor="#6699ff"><div align="center"><strong>district</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>%</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>APPLY</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>APPLIED</strong></div></td>
</tr>
</tr>
<%
for(vacmod rm:arrayList)
{
%>
<tr>
<td><%=rm.getVacid()%></td>
...
<td><%=rm.getDistrict()%></td>
<td><%=rm.getPercentage()%></td>
<% 
int count=vs.countbooking(rm.getVacid(),lm.getId());
int rr=1-count;

%>
<td align="center"><font color=" #6699ff"><%out.println(rr); %></font></td>
<%if(count==1)
	{%>
<td>
<font color="red"><%out.println("alredyaplied"); %></font>
</td>
<%
	}
else
...
<input type="hidden"name="reg"id="user"value="<%=lm.getId() %>">
<input type="hidden"name="vac"id="vac"value="<%=rm.getVacid() %>">
<input type="submit"name="operation"id="button"value="Apply">
</form>
</td>
</tr>
<%} }}%>
