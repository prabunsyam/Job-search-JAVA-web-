...
qualiservice rss=new qualiservice();
qualimod rm=rss.selectByid(Id);
%>
<form method="post"action="qualiservlet">
<table width="600"border="1">
<tr>
<td colspan="2"><div align="center"><strong>EDIT qualification</strong></div></td>
</tr>
<tr>
<td width="236">qualification</td>
<td width="348"><label><input type="text" name="Name"id="textfield1"value="<%=rm.getQualification()%>"/></label></td>
</tr>



<td><div align="center">
<label><input type="hidden"name="id"value="<%=rm.getQualificationid() %>"/>
