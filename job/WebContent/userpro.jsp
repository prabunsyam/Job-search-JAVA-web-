	        ...
	        <ul class="nav navbar-nav">
		        ...
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu">
			            <li><a href="#">jobvacancy</a></li>
			            <li><a href="state.jsp"></a></li>
		     ...
		     <li><a href="#">user</a></li>
		      ...
		      <li><a href="useruser.jsp">view me</a></li>
		    <li><a href="passchange.jsp">change pass</a></li>
...
<div class="banner">
	<div class="container">
		<div id="search_wrapper">
		 ...
		 <h1><a href="jobsrch.jsp">Start job search</a></h1>
