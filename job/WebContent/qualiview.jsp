...
<!-- <td bgcolor="#6699ff"><div align="center"><strong>STAUS</strong></div></td>-->
</tr>
</tr>
<%
for(qualimod rm:arr2)
{
%>
<tr>
<td><%=rm.getQualificationid()%></td>
<td><%=rm.getQualification()%></td>
<td><a href="qualiedit.jsp?id=<%=rm.getQualificationid()%>">Edit</a></td>
<!-- <td><%=rm.getSta()%></td> -->
