...
skservice rss=new skservice();
skillmod rm=rss.selectByid(Id);
%>
<form method="post"action="skservlet">
<table width="600"border="1">
<tr>
<td colspan="2"><div align="center"><strong>EDIT skill</strong></div></td>
</tr>
<tr>
<td width="236">skill</td>
<td width="348"><label><input type="text" name="Name"id="textfield1"value="<%=rm.getSkill()%>"/></label></td>
</tr>



<td><div align="center">
<label><input type="hidden"name="id"value="<%=rm.getSkillid() %>"/>
