	        ...
	        <ul class="nav navbar-nav">
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu">
			            <li><a href="userview.jsp">user</a></li>
			            <li><a href="compview.jsp">companies</a></li>
			            <li><a href="#">job post</a></li>
			            <li><a href="districtview.jsp">district</a></li>
			              <li><a href="stateview.jsp">state</a></li>
			              <li><a href="qualiview.jsp">qualifivation</a></li>
			               <li><a href="skillview.jsp">skill</a></li>
			                <li><a href="feedview.jsp">feedback</a></li>
