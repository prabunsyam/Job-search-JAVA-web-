...
dservice rss=new dservice();
dismod rm=rss.selectByid(Id);
%>
<form method="post"action="dservlet">
<table width="600"border="1">
<tr>
<td colspan="2"><div align="center"><strong>EDIT district</strong></div></td>
</tr>
<tr>
<td width="236">district</td>
<td width="348"><label><input type="text" name="Name"id="textfield1"value="<%=rm.getDistname()%>"tabindex="1"/></label></td>
</tr>
...
<td><div align="center">
<label><input type="hidden"name="id"value="<%=rm.getDisid() %>"/>
