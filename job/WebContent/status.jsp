    ...
    <div class="single">  
	   ...
	   <input type="hidden"name="type"value="<%=lm.getType() %>"/>
            ...
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="name"> status</label>
                <div class="col-md-5">
                    <td width="348"><label><td><%=lm.getStatus()%></td>
                    </label></td>
                </div>
            </div>
             <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="name">give aprooval</label>
                <div class="col-md-5">
                    <input type="text" path="name" name="ns"id="name" class="form-control input-sm"/>
                </div>
            </div>
         </div>
