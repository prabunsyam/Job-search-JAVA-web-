...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <form method="post"action="fgpservlet">
         
       
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="name">mailid</label>
                <div class="col-md-5">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <input type="submit" name="operation"id="button"value="getpwd" class="btn btn-primary btn-sm">
            </div>
        </div>
    </form>
    </div>
