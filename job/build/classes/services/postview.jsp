...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	   ...
	   <%postservices rr=new postservices();
	   ArrayList<postmod>arr1=rr.selectAllRegistration();
	   %>
<div class="banner">
	<div class="container">
...
<td bgcolor="#6699ff"><div align="center"><strong>postid</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>companyID</strong></div></td>
...
<td><a href="postedit.jsp?id=<%=rm.getPostid()%>">Edit</a></td>
