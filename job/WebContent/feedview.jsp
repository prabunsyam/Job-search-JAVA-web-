...
<%@page import="model.feedmod"%>
<%@page import="services.feedservice"%>
...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	   ...
	   <%feedservice rr=new feedservice();
	   ArrayList<feedmod>arr1=rr.selectAllRegistration();
	   %>
<div class="banner">
	<div class="container">
...
<td bgcolor="#6699ff"><div align="center"><strong>mailid</strong></div></td>
<td bgcolor="#6699ff"><div align="center"><strong>feedback</strong></div></td>
</tr>
</tr>
<%
for(feedmod rm:arr1)
