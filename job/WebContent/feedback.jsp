	        ...
	        <ul class="nav navbar-nav">
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu">
			            ...
			            <li><a href="#">Jobs by Function</a></li>
        ...
        <div class="row">
           ...
           <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                    <input type="text" path="email" name="mail" id="email" class="form-control input-sm"/>
                </div>
            </div>
        </div>   
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="80" rows="10" value=" " name="feed"onfocus="this.value='';" onblur="if (this.value == '') {this.value = '';}"> </textarea>
