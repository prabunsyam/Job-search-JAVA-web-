...
postservices rss=new postservices();
postmod rm=rss.selectByid(Id);
%>
<form method="post"action="postservelet">
<table width="600"border="1">
<tr>
<td colspan="2"><div align="center"><strong>EDIT post</strong></div></td>
</tr>
<tr>

<tr>
<td width="236">post</td>
<td width="348"><label><input type="text" name="Name"id="textfield1"value="<%=rm.getPost()%>"/></label></td>
</tr>

<td><div align="center">
<label><input type="hidden"name="id"value="<%=rm.getPostid() %>"/>
