...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	   ...
	   ArrayList<usermod>ar=rr.selectuser(id);
	   %> 
	   <%appservice as=new appservice();
	//   ArrayList<appmod>aa=rr.selectByid(Id);%>
<div class="banner">
	<div class="container">
...
%>
 ...
 <div class="row">
            ...
            <input type="hidden"name="cid" value="<%=lm.getId()%>">
            <input type="hidden"name="vid"value="<%=vid %>">
                <input  type="submit" name="operation"id="button"value="ACCEPT" class="btn btn-primary btn-sm">
            </div>        </div></td>
   <td bgcolor="#6699ff">         
<div class="row">
            <div class="form-actions floatRight">
                <input  type="submit" name="operation"id="button"value="reject" class="btn btn-primary btn-sm">
            </div>        </div></td>
